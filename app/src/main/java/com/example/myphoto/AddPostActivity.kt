    ...
    private fun uploadImage()
    {
        when {
            ...
            TextUtils.isEmpty(description_post.text.toString()) -> {
                Toast.makeText(this, getString(R.string.descriptionRequired), Toast.LENGTH_LONG).show()
            }
                ...
                uploadTask.continueWithTask(Continuation <UploadTask.TaskSnapshot, Task<Uri>>{ task ->
                    ...
                    if (task.isSuccessful)
                    {
                        ...
                        Toast.makeText(this,getString(R.string.PostSuccess),Toast.LENGTH_LONG).show()
